...
export function GroupsTable() {
  ...
  const {createGroup, createNewLoading ,createNewError} = useContext(GroupContext)
  ...
  function handleGroupOnChange(member) {
    ...
    if (found) {
      ...
      setSelectedUsers((prev) => [...prev, {_id:member._id, name:member.name, profileImage:member.profileImage}]);
    }
  }
  

  const handleCreateChat = async() => {createGroup(inputGroup, selectedUsers)
  };
      ...
      <div className="m-auto w-4/6 h-5/6 bg-gray-300 rounded-md p-6 flex flex-col ">
        <div className="flex justify-start items-center">
          ...
          <Button
            ...
            >{createNewLoading ? "Creating Group..." : "Create Group"}
          </Button>
          <Input
            ...
            <div className="mx-4"><InputGroupFile /* onFileSelect={handleFileSelect} *//></div>
        </div>
        <Input
